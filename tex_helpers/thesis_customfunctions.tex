...
\newcommand{\summstat}[2]{\csvreader[filter strcmp={\var}{#1}]{\onedrive/PhD/Papers/CongoGBV/Tables/balance.csv}{var=\var,#2=\stat}{\stat}}
...
\newcommand{\coeffget}[3]{\csvreader[filter=\equal{\reg}{#1} \and \equal{\var}{#2}]{\onedrive/PhD/Papers/CongoGBV/Tables/regs.csv}{var=\var,reg=\reg,#3=\coeff}{\coeff}}

\newcommand{\incid}[2]{\csvreader[filter strcmp={\key}{#1}]{\onedrive/PhD/Papers/CongoGBV/Tables/incidence.csv}{key=\key,#2=\inc}{\inc}}
