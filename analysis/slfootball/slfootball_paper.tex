...
\title{Conflict Exposure and Competitiveness}
\subtitle{Experimental Evidence from the Football Field in Sierra Leone}
...
\begin{center}
  \begin{threeparttable}[p!]
    ...
    % \small
    % \normalsize
    \input{"../../chapters/slfootball/tables/t1.tex"}
    \begin{tablenotes}
      \footnotesize
...
\begin{table}[p!]
  ...
  \begin{threeparttable}[p!]
    ...
    \input{"../../chapters/slfootball/tables/t3.tex"}
    \begin{tablenotes}
      \footnotesize
...
\begin{threeparttable}
  ...
  % \small
  % \normalsize
  \input{"../../chapters/slfootball/tables/t4.tex"}
  \begin{tablenotes}
    \footnotesize
...
\begin{threeparttable}
  ...
  \small
  % \normalsize
  \input{"../../chapters/slfootball/tables/t5.tex"}
  \begin{tablenotes}
    \footnotesize
...
\begin{threeparttable}
  \singlespacing
  \small
  \input{"../../chapters/slfootball/tables/t6.tex"}
  \begin{tablenotes}
    \footnotesize
...
\begin{threeparttable}
  ...
  \small
  % \normalsize
  \input{"../../chapters/slfootball/tables/ta1.tex"}
  \begin{tablenotes}
    \footnotesize
...
\begin{threeparttable}[p!]
  ...
  %\small
  % \normalsize
  \input{"../../chapters/slfootball/tables/ta2.tex"}
  \begin{tablenotes}
    \footnotesize
...
\begin{threeparttable}[p!]
  ...
  \small
  % \normalsize
  \input{"../../chapters/slfootball/tables/ta3.tex"}
  \begin{tablenotes}
    \footnotesize
...
\begin{threeparttable}[p!]
  ...
  \small
  % \normalsize
  \input{"../../chapters/slfootball/tables/ta4.tex"}
  \begin{tablenotes}
    \footnotesize
