...
- The data set is old: more than ten years. This means that many things that were once easily recognizable are now unlikely to be able to be used as key variables.
