\chapter{Markets and the determinants of sending behaviour in an Investment Game}
\pubinfo{Koen Leuveld and Niccoló Meriggi. \textit{Dissecting an Investment Game: Evidence From a Field Experiment in Rural Cameroon} (Working Paper)}
...
\begin{threeparttable}
	...
	\input{"chapters/cameroontrust/tables/summstats.tex"}
	\begin{tablenotes}
		\footnotesize
...
\begin{threeparttable}
	...
	\input{"chapters/cameroontrust/tables/results_expect.tex"}
	\begin{tablenotes}
		\footnotesize
...
\begin{threeparttable}
	...
	\input{"chapters/cameroontrust/tables/basic.tex"}
	\begin{tablenotes}
		\footnotesize
		\item \camsig; \camcluster; \camcontrols.
		\item
...
\begin{threeparttable}
	...
	\input{"chapters/cameroontrust/tables/interactions.tex"}
	\begin{tablenotes}
		\footnotesize
		\item \camsig; \camcluster; \camcontrols.
		\item
...
\begin{threeparttable}
	...
	\input{"chapters/cameroontrust/tables/interactions_w.tex"}
	\begin{tablenotes}
		\footnotesize
		\item \camsig; \camcluster; \camcontrols.
		\item
...
\begin{center}
\singlespacing
\input{"chapters/cameroontrust/tables/balance_noweight.tex"}
\end{center}

\begin{center}
\singlespacing
\input{"chapters/cameroontrust/tables/balance_weight.tex"}
\end{center}
