...
%problem statement
Almost two billion people live in Fragile States \todo{cite}. These fragile states are characterized by weak state capacity, leaving its citizens vulnerable to various shocks, such as conflicts and natural disasters. WHAT ARE OTHER CHARACTERISTICS OF THESE STATES? POVERTY? WAR? FAMINE? This has serious consequences for these citizens. Whereas the world as a whole has made large strides in improving living standards, poverty remains the norm in fragile states: two thirds of the world's exteme poor live in fragile states. Given the fact that conflict has increased since 2010, and climate change makes weather-related natural distasters more likely, this presents a WHAT NOW. World-wide efforts to address this, have not had the desired effect. HOW MUCH MONEY WAS SPENT? WHAT STATES ARE FRAGILE? MAP? 
