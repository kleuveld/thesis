...
\begin{threeparttable}
	...
	\centering
	\input{"\onedrive/PhD/Papers/CongoGBV/Tables/dhs_compare.tex"}
	\begin{tablenotes}
	\small
...
\input{\onedrive/PhD/Papers/CongoGBV/Tables/balance.tex}
...
\begin{figure}[htb]
  \includegraphics[width=0.6\linewidth]{\onedrive/PhD/Papers/CongoGBV/Figures/meancompare_overall.png}
...
\begin{figure}[htb]
  \includegraphics[width=\linewidth]{\onedrive/PhD/Papers/CongoGBV/Figures/meancompare_conf.png}
...
\input{"\onedrive/PhD/Papers/CongoGBV/Tables/conflict_by_terr"}
\end{table}
...
\meandifftab{"\onedrive/PhD/Papers/CongoGBV/Tables/meandifftab_conf.csv"}
\end{table}

\subsection{Intra-household bargaining position}
\begin{figure}[htb]
  \includegraphics[width=\linewidth]{\onedrive/PhD/Papers/CongoGBV/Figures/meancompare_mar.png}
...
\meandifftab{"\onedrive/PhD/Papers/CongoGBV/Tables/meandifftab_mar.csv"}
\end{table}
...
\begin{threeparttable}
	...
	\centering
	\scriptsize
	\input{"\onedrive/PhD/Papers/CongoGBV/Tables/results_regression.tex"}
...
\bibliography{\onedrive/Literatuur/Mendeley/Bibtex/Thesis-CongoGBV}
...
\begin{threeparttable}[htb]
	...
	\begin{center}
	\input{"\onedrive/PhD/Papers/CongoGBV/Tables/attrition.tex"}
	\begin{tablenotes}
...
\begin{threeparttable}
	...
	\scriptsize 
	\centering
	\input{"\onedrive/PhD/Papers/CongoGBV/Tables/determinants_regression.tex"}
