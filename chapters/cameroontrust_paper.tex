...
\begin{threeparttable}[htb]
	...
	\centering
	\input{"\dropbox/PhD/Papers/CameroonTrust/Tables/summstats.tex"}
	\begin{tablenotes}
...
\begin{threeparttable}[htb]
	...
	\centering
	\input{"\dropbox/PhD/Papers/CameroonTrust/Tables/results_expect.tex"}
	\begin{tablenotes}
		\footnotesize
...
\begin{threeparttable}[htb]
	...
	\input{"\dropbox/PhD/Papers/CameroonTrust/Tables/basic.tex"}
	\begin{tablenotes}
		\footnotesize
		\item \camsig; \camcluster; \camcontrols.
		\item
...
\begin{threeparttable}[htb]
	...
	\centering
	\input{"\dropbox/PhD/Papers/CameroonTrust/Tables/interactions.tex"}
	\begin{tablenotes}
		\footnotesize
		\item \camsig; \camcluster; \camcontrols.
		\item
...
\begin{threeparttable}[htb]
	...
	\centering
	\input{"\dropbox/PhD/Papers/CameroonTrust/Tables/interactions_w.tex"}
	\begin{tablenotes}
		\footnotesize
		\item \camsig; \camcluster; \camcontrols.
		\item
...
\bibliography{\dropbox/Literatuur/Mendeley/Bibtex/Thesis-CameroonTrust}
...
\input{"\dropbox/PhD/Papers/CameroonTrust/Tables/balance_noweight.tex"}
\input{"\dropbox/PhD/Papers/CameroonTrust/Tables/balance_weight.tex"}
